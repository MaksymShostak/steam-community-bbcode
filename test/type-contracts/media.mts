...
const video: SteamEmbeddedMedia = {
...
const noSource: SteamEmbeddedMedia = {
  type: "steamEmbeddedMedia",
  mediaKind: "youtube",
  constructId: "steam.bbcode.previewyoutube",
  children: [],
...
const hosted: SteamEmbeddedMedia = {
  type: "steamEmbeddedMedia",
  mediaKind: "video",
...
const preview: SteamPreviewImage = {
  type: "steamPreviewImage",
  constructId: "steam.bbcode.previewimg",
  image: { kind: "guideImage", steamImageId: "420", fileName: "example.png" },
  alt: "A view",
  rawSource: "[previewimg...]",
  size: "full",
};
const imageRoot: SteamMdastRoot = {
  type: "root",
  children: [{ type: "paragraph", children: [preview] }],
};
const invalidReference: SteamPreviewImage = {
  ...preview,
  // @ts-expect-error An unresolved guide reference cannot masquerade as a URL.
  image: { kind: "url", steamImageId: "420", fileName: "image.png" },
};
