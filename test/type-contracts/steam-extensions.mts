...
const opaque: SteamNoParse = {
  type: "steamNoParse",
  value: "[b]*literal*[/b]",
};
const nested: SteamMdastRoot = {
  type: "root",
  children: [
    {
      type: "paragraph",
      children: [
        {
          ...
          children: [
            {
              type: "steamUnderline",
              children: [{ type: "steamSpoiler", children: [opaque] }],
            },
          ],
        },
      ],
...
const invalidChild: SteamUnderline = {
  type: "steamUnderline",
  children: [
...
const quote: SteamAttributedBlockquote = {
  ...
  children: [
    {
      type: "paragraph",
      children: [{ type: "steamColor", color: "#123456", children: [opaque] }],
    },
  ],
};
const blockSpoiler: SteamBlockSpoiler = {
  type: "steamBlockSpoiler",
  children: [quote, { type: "steamPullQuote", children: [] }],
};
const blockRoot: SteamMdastRoot = { type: "root", children: [blockSpoiler] };
const badBlockSpoiler: SteamBlockSpoiler = {
  type: "steamBlockSpoiler",
  children: [
