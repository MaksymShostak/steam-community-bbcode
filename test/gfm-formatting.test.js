...
const formattingCases = [
  ...
  [
    "redundant bold through italic",
    "[b]a[i]b[b]c[/b]d[/i]e[/b]",
    "**a*bcd*e**",
  ],
  ["padded deletion", "[strike] D [/strike]", "~~&#x20;D&#x20;~~"],
  ["tab padded deletion", "[strike]\tD\t[/strike]", "~~&#x9;D&#x9;~~"],
  [
    "nonbreaking padded deletion",
    "[strike]\u00a0D\u00a0[/strike]",
    "~~&#xA0;D&#xA0;~~",
  ],
  ...
  [
    "links within retained style",
    "[b]a[url=https://example.org]b[b]c[/b][/url]d[/b]",
    "**a[bc](https://example.org)d**",
  ],
  [
    "adjacent distinct link destinations",
    "[b][url=https://one.example]a[/url][url=https://two.example]b[/url][/b]",
    "**[a](https://one.example)[b](https://two.example)**",
  ],
  [
    "adjacent distinct presentation",
    "[b]a[/b][i]b[/i][strike]c[/strike]",
    "**a***b*~~c~~",
  ],
  [
    "link followed by formatted text",
    "[url=https://one.example][b]a[/b][/url][b]b[/b]",
    "[**a**](https://one.example)**b**",
  ],
  [
    "opaque punctuation within style",
    "[b][noparse]*[x]*[/noparse][b]z[/b][/b]",
    "**\\*\\[x]\\*z**",
  ],
  ["heading style", "[h2][b]a[b]b[/b][/b][/h2]", "## **ab**"],
  [
    "table cell style",
    "[table][tr][th][b]a[/b][b]b[/b][/th][/tr][tr][td][strike]c[strike]d[/strike][/strike][/td][/tr][/table]",
    "| **ab** |\n| --- |\n| ~~cd~~ |",
  ],
];
for (const [name, source, expected] of formattingCases) {
  test(`GFM formatting preserves ${name}`, () => {
    ...
    assert.ok(
      result.coverage.constructs.every(
        (outcome) => outcome.fidelity === "exact",
      ),
    );
  });
}
